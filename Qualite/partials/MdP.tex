...
\LQSchema{
    Chaque état du système est représenté par un rectangle avec un choix de nom
    très précis et clair pour une bonne compréhension. Les transistions se font
    d'un état A à un état B et sont représentés par des fleches. Une
    transistions peut aussi se faire d'un état A vers un état A également. Une
    transistion n'est possible que si elle respecte une condition. Cette
    condition équivaut à une action du MdE.
}
